package com.gct.gamecode.t5.util;
...
public class ImgUtils {
	...
	static { //load img when using
		...
		try {
			filePath = URLDecoder.decode(ImgUtils.class.getClassLoader().getResource("").getPath(), "utf-8");
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("2:" + ImgUtils.class.getClassLoader().getResource("").getPath());  
		System.out.println("3:" + ClassLoader.getSystemResource("").getPath());  
		System.out.println("4:" + ImgUtils.class.getResource("").getPath());//IdcardClient.class文件所在路径  
		System.out.println("5:" + ImgUtils.class.getResource("/").getPath()); // Class包所在路径，得到的是URL对象，用url.getPath()获取绝对路径String  
		...
		//第一种结果（前边有个斜线）
				System.out.println(ImgUtils.class.getClassLoader().getResource(".").getPath());
				System.out.println("===========华丽丽的分割线===========");
				//第二种结果（前边以file打头）
				System.out.println(Thread.currentThread().getContextClassLoader().getResource(""));
				System.out.println(ClassLoader.getSystemResource(""));
				System.out.println(ImgUtils.class.getResource(""));
				System.out.println(ImgUtils.class.getResource("/"));
				System.out.println("===========华丽丽的分割线===========");
				//第三种结果（定位到工程目录）
