package com.gct.gamecode.t2.constant;

import java.awt.Color;

public interface MyConstant2 {
	 ...
	 * 默认窗口的宽度
	 */
	int DEF_FRAME_WIDTH = 450;
	/**
	 * 默认窗口的高度
	 */
	int DEF_FRAME_HEIGHT = 300;
	/**
	 * 初始化步长X
	 */
	int DEF_STEP_LEN_X = 20;
	/**
	 * 初始化步长Y
	 */
	int DEF_STEP_LEN_Y = 20;
	/**
	 * 默认圆高度
	 */
